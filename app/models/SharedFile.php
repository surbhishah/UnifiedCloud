...
/**********************************************************************************************/	
	public static function getFilesSharedByUser($ownerID){
		return DB::select('
			SELECT files.fileID, files.path,shared_files.sharerID, file_name, shared_files.created_at, first_name,last_name,email
			FROM shared_files
...
/**********************************************************************************************/	
        public static function getFilesSharedWithUser($sharerID){
        	return DB::select('
        		SELECT files.fileID,files.path, shared_files.ownerID, file_name, shared_files.created_at, first_name,last_name,email
				FROM shared_files
