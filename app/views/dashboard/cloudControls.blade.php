 <div class="nav cloud-control">
 	<ul class="list-inline pull-left cloud-control-buttons search-bar">
 		<li>
 			<span class="input-group">
		      <input type="text" id="file-search" class="form-control" placeholder="Search...">
    ...
    <ul class="list-inline pull-right cloud-control-buttons">        
        ...
        <li><span class="glyphicon glyphicon-link" id="share" data-toggle="modal" data-target="#shareModal">    
        </span></li>
        <li><span class="glyphicon glyphicon-tags" id="group"></span></li>
