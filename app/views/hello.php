...
<html lang="en">
<head>
	<link rel="stylesheet" href="packages/css/stylesheets/jquery.contextMenu.css">
	<meta charset="UTF-8">
...
<body >
	<div class="welcome context-menu-one box menu-1">
	...
	<script src="packages/bootstrap/js/jquery-1.10.js"></script>
	<!-- <script src="packages/js/jquery.ui.position.js"></script> -->
	<script src="packages/js/jquery.contextMenu.js"></script>
